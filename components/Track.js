export default function Track(track) {
  return (
    <div className="flex flex-row items-baseline border-b border-gray-200 dark:border-gray-800 max-w-3xl w-full mt-8 hover:bg-green-100/40 hover:dark:bg-green-500/50 rounded-md p-4 ">
