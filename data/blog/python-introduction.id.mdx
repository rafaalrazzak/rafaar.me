...
images: ['https://res.cloudinary.com/dvs0hvjsf/image/upload/v1650957837/blog/python.jpg']
layout: PostLayoutPostLayout

<Image
  alt="Header"
  src="https://res.cloudinary.com/dvs0hvjsf/image/upload/v1650957837/blog/python.jpg"
  width={1000}
  height={700}
  className="rounded-rounded-lglg"
  objectFit="cover"
/>
