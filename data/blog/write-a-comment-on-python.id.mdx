---
title: 'Menulis Komentar Pada Python'
date: '2022-05-07T07:19:28.000Z'
tags: ['python', 'dasar']
draft: false
summary: 'Menulis sebuah komentar dalam bahasa pemrograman python'
thumbnail: true
layout: PostLayout
---
...
Saat anda menjalankan script diatas, Anda akan melihat output berupa `Hello World`, `Ilham Kurniawan` dan `123`, karena tulisan/komentar yang ditulis tidak dieksekusi.
