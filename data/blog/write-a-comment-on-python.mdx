...
tags: ['python', 'basic']
draft: False
summary: 'Writing a comment in Python Programming Language'
thumbnail: True
layout: PostSimple
---
...
When you run the script above, you will see the output in the form of 'Hello World', 'Budi' and '123', because the writing/comments written are not executed.
