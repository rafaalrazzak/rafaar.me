...
export const notionConverter = (recordMap, source) => {
	...
	const author = {
		name: recordMap.properties.author.created_by.name, avatar: recordMap.properties.author.created_by.avatar_url
	}
	...
	return {
		title, description, created_time, last_edited_time, slug, image, author, tags, layout, readingTime
	}
}