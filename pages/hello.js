...
export async function getServerSideProps(){
	...
	const renderer = await serialize(mdString, {
		mdxOptions: {
			...
			rehypePlugins: [rehypeSlug, rehypePresetMinify, rehypeAutolinkHeadings, rehypeKatex, rehypePrismPlus,],
		}
	})
...
export default function Hello({renderer, frontMatter, mdString}){
	...
	return (
			<NotionRenderer source={renderer} frontMatter={notionConverter(frontMatter, String(mdString))}
